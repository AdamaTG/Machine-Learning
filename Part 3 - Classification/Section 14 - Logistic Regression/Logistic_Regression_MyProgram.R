...
# Feature Scaling
 ...
 y_pred = ifelse(prob_pred > 0.5, 1, 0) # To give result as 0 or 1 instead of a probability (There is no inbuilt function for accomplishing this)
 ...
 grid_set = expand.grid(X1, X2) #Matrix of age and salaries
 colnames(grid_set) = c('Age', 'EstimatedSalary') #Giving the names to the matrices
