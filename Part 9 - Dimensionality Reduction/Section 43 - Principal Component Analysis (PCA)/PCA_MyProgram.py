# PCA (Based on Logistic Regression)
...
pca = PCA(n_components = 2) #We use None here initially instead of 2 since we need to compare all the variances of the independent variables and then choose the two best ones.
X_train = pca.fit_transform(X_train) #We dont take the dependent variable (y_train in this case) as PCA is unsupervised
X_test = pca.transform(X_test)
explained_variance = pca.explained_variance_ratio_ #Shows the variance of each individual component
